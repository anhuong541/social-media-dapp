...
export default function Home() {
  const { appStatus, connectWallet } = useContext<any>(TwitterContext);
  ...
  const noUserFound = (
    <div className={style.loginContainer}>
      <Image src="/metamask.png" alt="metamask" width={200} height={200} />
      <div
  ...
  const error = (
    <div className={style.loginContainer}>
      <Image src="/mark-icon/error.pg" alt="error" width={250} height={200} />
      <div className={style.loginContent}>
